        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start mb-10 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start max-w-sm">
            <div className="flex items-center gap-2 mb-4">
              <FiFeather className="text-primary text-xl" />
              <span className="text-xl font-bold">Zenfla</span>
            </div>
            <p className="text-sm text-white/70 text-center md:text-left mb-4">
              A digital sanctuary for thoughtful discourse, creative expression,
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/blogs" className="link link-hover text-sm">
                All Articles
              </Link>
